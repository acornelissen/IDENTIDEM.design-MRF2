#ifndef SCREENSHOT_STUB_PREFERENCES_H
#define SCREENSHOT_STUB_PREFERENCES_H

#include <stddef.h>
#include <stdint.h>

// Inert NVS. globals.cpp defines `Preferences prefs;` but the generator never
// loads or saves anything.
class Preferences
{
public:
...
#endif // SCREENSHOT_STUB_PREFERENCES_H
