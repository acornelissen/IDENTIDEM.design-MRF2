...
const int LIDAR_FUSION_MIN_INTENSITY_MID = 14;
const int LIDAR_FUSION_MIN_INTENSITY_FAR = 8;
const int LIDAR_FUSION_MIN_INTENSITY_MAX_RANGE = 4;
...
const int LIDAR_TEMPORAL_PENALTY_MAX = 18;
...
const int CONFIG_ROOT_STEP_RESET = 3;
const int CONFIG_ROOT_STEP_HEALTH = 4;
const int CONFIG_ROOT_STEP_SLEEP_TIMEOUT = 5;
