...
const int CONFIG_ROOT_STEP_ISO = 0;
const int CONFIG_ROOT_STEP_FILM_MENU = 1;
const int CONFIG_ROOT_STEP_SLEEP_TIMEOUT = 2;
...
const int CONFIG_METER_STEP_EV_COMP = 0;
const int CONFIG_METER_STEP_SMOOTHING = 1;
const int CONFIG_METER_STEP_EV_READOUT = 2;
const int CONFIG_METER_STEP_BACK = 3;
