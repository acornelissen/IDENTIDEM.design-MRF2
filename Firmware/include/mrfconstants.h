...
const int LIDAR_FUSION_MIN_INTENSITY = 150;
const int LIDAR_CONFIDENCE_HIGH = 75;
const int LIDAR_CONFIDENCE_MEDIUM = 55;
const float LIDAR_MEDIUM_CONF_BLEND = 0.35f;
const float LIDAR_LENS_PRIOR_WEIGHT_GOOD = 0.20f;
const float LIDAR_LENS_PRIOR_WEIGHT_EXCELLENT = 0.08f;
...
const int CONFIG_STEP_ISO = 0;
const int CONFIG_STEP_FORMAT = 1;
const int CONFIG_STEP_LENS = 2;
const int CONFIG_STEP_PARALLAX = 3;
const int CONFIG_STEP_EV_COMP = 4;
const int CONFIG_STEP_METER_SMOOTHING = 5;
const int CONFIG_STEP_EV_READOUT = 6;
const int CONFIG_STEP_LENS_CALIB = 7;
const int CONFIG_STEP_RESET = 8;
const int CONFIG_STEP_EXIT = 9;
const int CONFIG_STEP_MAX = CONFIG_STEP_EXIT;
